...
<div class="box">
    <div class="box-header with-border">
        <form class="nd-search-form" action="<?php echo htmlentities($action_list['search']); ?>">
            <div class="col-sm-6 nd-search-item"></div>
            <div class="col-sm-3 nd-search-item">
                <?php echo $date_rage_html; ?>
            </div>
            <div class="col-sm-3 nd-search-item">
    ...
    <div class="box-body table-responsive">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="hidden-xs"><?php echo htmlentities($vo['login_agent']); ?></td>
