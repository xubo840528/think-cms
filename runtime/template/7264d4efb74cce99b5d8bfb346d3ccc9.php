    ...
    <div class="box-body table-responsive">
        <table id="menu-tree" class="table table-hover">
            ...
            <tr>
                ...
                <td><?php echo htmlentities($vo['manager']); ?></td>
                <td><?php echo htmlentities($vo['type']); ?></td>
                <td><?php echo htmlentities($vo['target']); ?></td>
                <td><?php echo htmlentities($vo['inserted']); ?></td>
            </tr>
