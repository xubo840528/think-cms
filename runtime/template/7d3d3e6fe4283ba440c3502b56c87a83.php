...
<div class="box">
    <div class="row">
        <form  class="ajax-form" action="<?php echo url('edit'); ?>">
        <div class="col-md-6">
            ...
            <div class="box-body">
                ...
                <?php echo $typeHtml; ?>
                <?php echo $widget->form('text', ['title' => '昵称', 'name' => 'name', 'value' => $info['name']]); ?>
                <?php echo $imageHtml; ?>
                <?php echo $widget->form('text', ['title' => '排序', 'name' => 'sort', 'value' => $info['sort']]); ?>
                <?php echo $widget->form('text', ['title' => '手机', 'name' => 'mobile', 'value' => $info['mobile']]); ?>
                <?php echo $widget->form('text', ['title' => '密码', 'name' => 'password', 'value' => $info['password']]); ?>
                <?php echo $widget->form('text', ['title' => '编码', 'name' => 'num', 'value' => $info['num']]); ?>

                <?php echo $widget->form('text', ['title' => '底薪', 'name' => 'salary', 'value' => $info['salary']/100]); ?>
                <?php echo $widget->form('text', ['title' => '单价', 'name' => 'price', 'value' => $info['price']/100]); ?>
                <?php echo $widget->form('text', ['title' => '提成(%)', 'name' => 'rate', 'value' => $info['rate']/100]); ?>
                <?php echo $widget->form('text', ['title' => 'title', 'name' => 'title', 'value' => $info['title']]); ?>
                <?php echo $widget->form('text', ['title' => '擅长领域', 'name' => 'tags', 'value' => $info['tags'],'placeholder'=>'逗号分隔']); ?>
                <?php echo $widget->form('textarea', ['title' => '职称', 'name' => 'info', 'value' => $info['info']]); ?>
                <?php echo $widget->form('textarea', ['title' => '一封信', 'name' => 'descr', 'value' => $info['descr']]); ?>
                <?php echo $widget->form('textarea', ['title' => '详情', 'name' => 'detail', 'value' => $info['detail']]); ?>
                <?php echo $widget->form('textarea', ['title' => '培训经历', 'name' => 'remark', 'value' => $info['remark']]); ?>



            </div>
            <div class="box-footer">
                <a class="btn btn-primary ajax-post"><i class="fa fa-save"></i> 保存</a>
