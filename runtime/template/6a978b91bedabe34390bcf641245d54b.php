    ...
    <div class="box-body table-responsive">
        <table id="menu-tree" class="table table-hover">
            ...
            <tr>
                ...
                <td><?php echo htmlentities($vo['deadline']); ?></td>
            </tr>
