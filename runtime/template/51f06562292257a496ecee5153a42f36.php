...
<div class="box">
    <div class="box-body table-responsive">
        <table class="table table-bordered table-hover">
            <?php if(is_array($server_info) || $server_info instanceof \think\Collection || $server_info instanceof \think\Paginator): $i = 0; $__LIST__ = $server_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
            <tr>
                <td width="200px" class="text-primary"><?php echo htmlentities($key); ?></td>
                <td><?php echo $value; ?></td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            <tr>
                <td class="text-primary">扩展列表</td>
                <td><?php echo htmlentities($extensions_list); ?></td>
            </tr>
        </table>
    </div>
</div>
